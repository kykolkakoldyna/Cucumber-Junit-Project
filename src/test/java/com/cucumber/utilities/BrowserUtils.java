...
public class BrowserUtils {
    public static void multiWindowsVerify(String expectedURL, String expectedTitle){
    ...
    // will accept a dropdown as WebElement and will return as a list of string
    ...
    // will accept a group of radio buttons as a list of WebElements, will loop through the list, and will click to the radio button with provided attribute value
    ...
    // switches to the new window by the exact title; returns to the original window if target title not found
